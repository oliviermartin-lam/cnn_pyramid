...
jIndex      = [4,5,6];          % Noll's indexes of the Zernike modes to be simulated for the Zernike Generator - 1 is piston
nZern       = 50;               % number of Zernike to be reconstructed for the Fourier generator
zStdMax     = [100];            % Vector of size (1,numel(jIndex)) containing Std of the Zernike amplitude in nm
